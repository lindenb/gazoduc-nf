...
script:
    ...
    if(max_to_merge.isEmpty()) throw new IllegalArgumentException("undefined max_to_merge for ${task.process}");
    if(output_type.isEmpty()) throw new IllegalArgumentException("undefined output_type for ${task.process}");
